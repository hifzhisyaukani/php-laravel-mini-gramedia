        ...
        <div class="card-body">
            <form action="{{ route('admin.book-categories.update', $bookCategory->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    {{-- old('name', $bookCategory->name) : jika ada error validasi, tampilkan nilai nilai sebelumnya pada inputan ini, jika tidak ada, tampilkan nilai dari $bookCategory->name --}}
